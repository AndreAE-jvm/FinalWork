...
5. Ввести количество забитых мячей у каждой команды.
6 Ввести количество пропущенных мячей у каждой команды.
7. Определить разницу между забитыми и пропущенными мячами у каждой команды
7.1 Вывести разницу забитых и пропущенных мячей на экран.
8. Определить команду с самым большим количеством побед.
9. Вывести команду с самым большим количеством побед. "Команда с самым большим количеством побед : " 1. Spartak 10 побед
10. Определить общее количество побед со всех команд
11. Определить среднее количество побед со всех команд (общее количество побед / количество команд)
Вывести команды с количеством побед больше среднего.
"Команды с количеством побед больше среднего : "
 Spartak
 Zenit
12. Сделать сортировку команд по убыванию мест в лиге (по количеству побед).
12.1 Вывести команды по убыванию мест в лиге (по количеству побед).
" Команды по убыванию мест в лиге (по количеству побед) : "
1 Spartak
2 Zenit
3 Dinamo
13. Вывести нумерацию место в лиге. Для каждой команды. Добавить столбец место в лиге.
Добавить переменную в тип данных int number
14. Вывести поиск по названию команды
(Город, место_в_лиге, количество_побед, количество забитых и пропущенных мячей), исправление одного из полей
и вывод полной информации о команде после редактирования.
